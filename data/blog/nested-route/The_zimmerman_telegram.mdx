...
## <mark className='bg-blue-500 p-1 rounded-md'>Background</mark>
...
## <mark className='bg-blue-500 p-1 rounded-md'>Germany’s Idea.</mark>
...
## <mark className='bg-blue-500 p-1 rounded-md'>Information in the telegraph.</mark>
---
...
## <mark className='bg-blue-500 p-1 rounded-md'>The Britisher’s Dilemma.</mark>
...
## <mark className='bg-blue-500 p-1 rounded-md'>The Brits Plan</mark>
...
## <mark className='bg-blue-500 p-1 rounded-md'>The Entry of the US into World War 1.</mark>
...
## <mark className='bg-blue-500 p-1 rounded-md'>Could the US be prevented from entering the war??</mark>
